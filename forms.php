    ...
    <div class="form-container">
        ...
        <form action="submit.php" method="post">
            ...
            <div class="step" id="step3">
                ...
                <input type="radio" name="dealingWithCurriculum" value="3"> Fully <br>
            ...
            <div class="step" id="step5">
                ...
                <button type="button" onclick="showStep(6);">Next</button>
            </div>
            ...
            <div class="step" id="step6">
                ...
                <button type="button" onclick="showStep(7);">Next</button>
            </div>
            ...
            <div class="step" id="step7">
                ...
                <button type="button" onclick="showStep(8);">Next</button>
            </div>
